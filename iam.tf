  ...
  "Statement": [
    {
      ...
      "Condition": {
        "StringEquals": {
          ...
          "${replace(module.open-webui-eks.cluster_oidc_issuer_url, "https://", "")}:aud": "sts.amazonaws.com"
        }
      }
    }
  ]
  ...
  "Statement": [
    {
      ...
      "Condition": {
        "StringEquals": {
          "${replace(module.open-webui-eks.cluster_oidc_issuer_url, "https://", "")}:sub": "system:serviceaccount:kube-system:external-dns",
          "${replace(module.open-webui-eks.cluster_oidc_issuer_url, "https://", "")}:aud": "sts.amazonaws.com"
        }
      }
    }
